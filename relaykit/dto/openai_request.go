...
func (r *GeneralOpenAIRequest) GetTokenCountMeta() *types.TokenCountMeta {
	...
	if maxCompletionTokens > maxTokens {
		tokenCountMeta.MaxTokens = types.SaturatingUintToInt(maxCompletionTokens)
	} else {
		tokenCountMeta.MaxTokens = types.SaturatingUintToInt(maxTokens)
	}
...
func (r *OpenAIResponsesRequest) GetTokenCountMeta() *types.TokenCountMeta {
	...
	return &types.TokenCountMeta{
		...
		Files:       fileMeta,
		MaxTokens:   types.SaturatingUintToInt(lo.FromPtrOr(r.MaxOutputTokens, uint(0))),
	}
}
