...
var auditContentTemplates = map[string]string{
	...
	"subscription.paid_uncredited_retry": "Retried paid-uncredited subscription order ${trade_no}",
	"topup.paid_uncredited_retry":        "Retried paid-uncredited top-up order ${trade_no}",
}
