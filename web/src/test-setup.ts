...
// Node 26 + jsdom may expose an opaque origin without a usable localStorage
// object. Keep storage-dependent component tests deterministic without
// changing browser behavior in production.
...
try {
  window.localStorage.setItem('__test_storage_probe__', '1')
  window.localStorage.removeItem('__test_storage_probe__')
} catch {
