...
export function SecureVerificationDialog({
  ...
  return (
    <Dialog
      ...
      contentClassName='top-[8vh] max-w-[calc(100%-1.5rem)] translate-y-0 overflow-hidden border-none shadow-lg sm:top-1/2 sm:max-w-md sm:translate-y-[-50%] sm:rounded-lg'
