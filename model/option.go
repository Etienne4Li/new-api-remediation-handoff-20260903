...
func InitOptionMap() {
	...
	common.OptionMap["AffRebatePercent"] = strconv.Itoa(common.AffRebatePercent)
	common.OptionMap["AffRebateMaxTimes"] = strconv.Itoa(common.AffRebateMaxTimes)
...
func updateOptionMap(key string, value string) (err error) {
	...
	if strings.HasSuffix(key, "Enabled") || key == "DefaultCollapseSidebar" || key == "DefaultUseAutoGroup" || key == "SMTPForceAuthLogin" || key == "SMTPInsecureSkipVerify" {
		...
		case "AffRebateEnabled":
			common.AffRebateEnabled = boolValue
	...
	case "AffRebatePercent":
		common.AffRebatePercent, _ = strconv.Atoi(value)
	case "AffRebateMaxTimes":
		common.AffRebateMaxTimes, _ = strconv.Atoi(value)
